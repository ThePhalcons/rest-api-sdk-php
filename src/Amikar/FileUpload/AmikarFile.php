...
class AmikarFile
{
    ...
    protected $stream;
    /**
     * Creates a new AmikarFile entity.
     *
    ...
    public function open()
    {
        if (!$this->isRemoteFile($this->path) && !is_readable($this->path)) {
            throw new AmikarSDKException('Failed to create AmikarFile entity. Unable to read resource: ' . $this->path . '.');
        }
        $this->stream = fopen($this->path, 'r');
        if (!$this->stream) {
            throw new AmikarSDKException('Failed to create AmikarFile entity. Unable to open resource: ' . $this->path . '.');
        }
    }
    /**
