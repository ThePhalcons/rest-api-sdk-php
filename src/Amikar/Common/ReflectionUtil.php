...
use Amikar\Exception\AmikarConfigurationException;
...
class ReflectionUtil
{
     ...
     * @param $propertyName
     * @return null|string
     * @throws AmikarConfigurationException
     */
    public static function getPropertyClass($class, $propertyName)
    {
        if ($class == get_class(new AmikarModel())) {
            // Make it generic if AmikarModel is used for generating this
            return get_class(new AmikarModel());
        }
        ...
        if (isset($param)) {
            ...
            throw new AmikarConfigurationException("Getter function for '$propertyName' in '$class' class should have a proper return type.");
        }
    }

    /**
     * Checks if the Property is instance of type array or an object
     *
     * @param $class
     * @param $propertyName
     * @return bool|null
